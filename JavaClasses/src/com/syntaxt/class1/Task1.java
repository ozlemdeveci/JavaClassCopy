...
public class Task1 {
	  //Write a program with one int value 
	//for salary and four String values for different cars
    //If you make over 50000 a year, 
	//you may buy a brand new car otherwise you should buy a used car.
